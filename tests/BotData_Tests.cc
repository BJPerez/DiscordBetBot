...
TEST(BotData_Tests, AddMatch_ValidParameters)
{
	...
	ASSERT_NO_THROW(data.AddMatch({"TestId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }}));
...
{
	BotData data;
	data.AddMatch({"TestId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});

	ASSERT_THROW(data.AddMatch({std::string{ Match::INVALID_ID }, "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }}), InvalidMatchIdException);
	ASSERT_THROW(data.AddMatch({std::string{ "" }, "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }}), InvalidMatchIdException);
	ASSERT_THROW(data.AddMatch({"TestId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }}), MatchIdUnavailableException);
	ASSERT_THROW(data.AddMatch({"TestId2", "", "TeamB", 3, std::string{ "2100-01-31 18:00" }}), InvalidTeamNameException);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "", 3, std::string{ "2100-01-31 18:00" }}), InvalidTeamNameException);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "TeamB", 0, std::string{ "2100-01-31 18:00" }}), InvalidBoSizeException);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "TeamB", 2, std::string{ "2100-01-31 18:00" }}), InvalidBoSizeException);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "TeamB", 4, std::string{ "2100-01-31 18:00" }}), InvalidBoSizeException);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "TeamB", 3, std::string{ "Invalid" }}), InvalidDateFormat);
	ASSERT_THROW(data.AddMatch({"TestId2", "TeamA", "TeamB", 3, std::string{ "1990-01-01 18:00" }}), DateTimeInThePastException);
}
...
TEST(BotData_Tests, AddResult_ValidParameters)
{
	BotData data;
	data.AddMatch({"TestId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});
	data.AddMatch({"TestId2", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});
...
{
	BotData data;
	data.AddMatch({"PlayedMatchId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});
	data.AddMatch({"NonPlayedMatchId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});
...
{
	BotData data;
	data.AddMatch({"ExistingId", "TeamA", "TeamB", 3, std::string{ "2100-01-31 18:00" }});
